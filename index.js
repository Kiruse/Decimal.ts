...
var _Decimal_value, _Decimal_decimals;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Decimal = void 0;
class Decimal {
    constructor(value = 0, decimals = 0) {
        _Decimal_value.set(this, void 0);
        _Decimal_decimals.set(this, void 0);
        __classPrivateFieldSet(this, _Decimal_value, BigInt(value), "f");
        __classPrivateFieldSet(this, _Decimal_decimals, decimals, "f");
    }
    ...
    get value() {
        return __classPrivateFieldGet(this, _Decimal_value, "f");
    }
    get int() { return this.integer; }
    get integer() {
        return __classPrivateFieldGet(this, _Decimal_value, "f") / 10n ** BigInt(this.decimals);
    }
    get frac() { return this.fraction; }
    get fraction() {
        const tmp = __classPrivateFieldGet(this, _Decimal_value, "f") % 10n ** BigInt(this.decimals);
        return tmp < 0n ? -tmp : tmp;
    }
    get decimals() {
        return __classPrivateFieldGet(this, _Decimal_decimals, "f");
    }
}
exports.Decimal = Decimal;
_Decimal_value = new WeakMap(), _Decimal_decimals = new WeakMap();
